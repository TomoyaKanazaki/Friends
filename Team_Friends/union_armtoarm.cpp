...
// コンストラクタ
//==========================================================================
CUnion_ArntoArma::CUnion_ArntoArma(int nPriority) : CPlayerRanking(nPriority)
{
	// 値のクリア
	m_nInputSuperAtkIdx = 0;	// 必殺技入力のインデックス
	m_nIntervalAlternately = 0;	// 交互入力のインターバル
...
// デストラクタ
//==========================================================================
CUnion_ArntoArma::~CUnion_ArntoArma()
{
...
// 初期化処理
//==========================================================================
HRESULT CUnion_ArntoArma::Init(void)
{
	// 初期化
	CPlayerUnion::Init();
...
// パーツの設定
//==========================================================================
HRESULT CUnion_ArntoArma::CreateParts(void)
{
	CObjectChara *pObjChar = NULL;
...
// 終了処理
//==========================================================================
void CUnion_ArntoArma::Uninit(void)
{
	// 終了処理
	CPlayerUnion::Uninit();
}
...
// 更新処理
//==========================================================================
void CUnion_ArntoArma::Update(void)
{
	// カメラの情報取得
	CCamera *pCamera = CManager::GetInstance()->GetCamera();
...
// モーションの設定
//==========================================================================
void CUnion_ArntoArma::MotionSet(int nIdx)
{
	if (m_pMotion[nIdx] == NULL)
	{// モーションがNULLだったら
		return;
...
// 描画処理
//==========================================================================
void CUnion_ArntoArma::Draw(void)
{
	// 描画処理
	CPlayerUnion::Draw();
}
