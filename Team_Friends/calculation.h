...
float GetRandomCircleValue(void);													// 円範囲ランダム値取得
D3DXVECTOR3 GetRandomSphereVec(void);												// 球範囲ランダムベクトル取得
D3DXVECTOR3 GetRandomSpherePosition(D3DXVECTOR3 pos, float fRadius);				// 球範囲ランダム位置取得
...
float GetFabsPosLength(D3DXVECTOR3 pos1, D3DXVECTOR3 pos2);							// 長さの絶対値取得
