...
public:
	...
	CUnion_ArntoArm(int nPriority = mylib_const::DEF2D_PRIORITY);
	~CUnion_ArntoArm();
...
// プレイヤークラス定義
class CUnion_ArntoArma : public CPlayerRanking
{
public:

	CUnion_ArntoArma(int nPriority = mylib_const::DEF2D_PRIORITY);
	~CUnion_ArntoArma();
