//=============================================================================
// 
//  小規模合体プレイヤーヘッダー [union_bodytoleg.h]
//  Author : 相馬靜雅
// 
//=============================================================================

#ifndef _UNION_BODYTOLEG_H_
#define _UNION_BODYTOLEG_H_	// 二重インクルード防止
...
//==========================================================================
// プレイヤークラス定義
class CUnion_BodytoLeg : public CPlayerUnion
{
public:

	CUnion_BodytoLeg(int nPriority = mylib_const::DEF2D_PRIORITY);
	~CUnion_BodytoLeg();
...
// プレイヤークラス定義
class CUnion_BodytoLega : public CPlayerRanking
{
public:

	CUnion_BodytoLega(int nPriority = mylib_const::DEF2D_PRIORITY);
	~CUnion_BodytoLega();
