...
// コンストラクタ
//==========================================================================
CUnion_LegtoArma::CUnion_LegtoArma(int nPriority) : CPlayerRanking(nPriority)
{
...
// デストラクタ
//==========================================================================
CUnion_LegtoArma::~CUnion_LegtoArma()
{
...
// 初期化処理
//==========================================================================
HRESULT CUnion_LegtoArma::Init(void)
{
	// 初期化
	CPlayerUnion::Init();
...
// パーツの設定
//==========================================================================
HRESULT CUnion_LegtoArma::CreateParts(void)
{
	CObjectChara *pObjChar = NULL;
...
// 終了処理
//==========================================================================
void CUnion_LegtoArma::Uninit(void)
{
...
// 更新処理
//==========================================================================
void CUnion_LegtoArma::Update(void)
{
	// 更新処理
	CPlayerUnion::Update();
...
// モーションの設定
//==========================================================================
void CUnion_LegtoArma::MotionSet(int nIdx)
{
	if (m_pMotion[nIdx] == NULL)
	{// モーションがNULLだったら
		return;
...
// 描画処理
//==========================================================================
void CUnion_LegtoArma::Draw(void)
{
	// 描画処理
	CPlayerUnion::Draw();
}