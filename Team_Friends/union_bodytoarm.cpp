...
// コンストラクタ
//==========================================================================
CUnion_BodytoArma::CUnion_BodytoArma(int nPriority) : CPlayerRanking(nPriority)
{
...
// デストラクタ
//==========================================================================
CUnion_BodytoArma::~CUnion_BodytoArma()
{
...
// 初期化処理
//==========================================================================
HRESULT CUnion_BodytoArma::Init(void)
{
	// 初期化
	CPlayerUnion::Init();
...
// パーツの設定
//==========================================================================
HRESULT CUnion_BodytoArma::CreateParts(void)
{
	// 複数キャラ読み込み
	ReadMultiCharacter("data\\TEXT\\multicharacter\\BodytoArm.txt");
	return S_OK;
...
// 終了処理
//==========================================================================
void CUnion_BodytoArma::Uninit(void)
{
...
// 更新処理
//==========================================================================
void CUnion_BodytoArma::Update(void)
{
	// 更新処理
	CPlayerUnion::Update();
...
// モーションの設定
//==========================================================================
void CUnion_BodytoArma::MotionSet(int nIdx)
{
	if (m_pMotion[nIdx] == NULL)
	{// モーションがNULLだったら
		return;
...
// 描画処理
//==========================================================================
void CUnion_BodytoArma::Draw(void)
{
	// 描画処理
	CPlayerUnion::Draw();
}
