...
// コンストラクタ
//==========================================================================
CUnion_BodytoLega::CUnion_BodytoLega(int nPriority) : CPlayerRanking(nPriority)
{
...
// デストラクタ
//==========================================================================
CUnion_BodytoLega::~CUnion_BodytoLega()
{
...
// 初期化処理
//==========================================================================
HRESULT CUnion_BodytoLega::Init(void)
{
	// 初期化
	CPlayerUnion::Init();
...
// パーツの設定
//==========================================================================
HRESULT CUnion_BodytoLega::CreateParts(void)
{
	CObjectChara *pObjChar = NULL;
...
// 終了処理
//==========================================================================
void CUnion_BodytoLega::Uninit(void)
{
...
// 更新処理
//==========================================================================
void CUnion_BodytoLega::Update(void)
{
	// 更新処理
	CPlayerUnion::Update();
...
// モーションの設定
//==========================================================================
void CUnion_BodytoLega::MotionSet(int nIdx)
{
	if (m_pMotion[nIdx] == NULL)
	{// モーションがNULLだったら
		return;
...
// 描画処理
//==========================================================================
void CUnion_BodytoLega::Draw(void)
{
	// 描画処理
	CPlayerUnion::Draw();
}